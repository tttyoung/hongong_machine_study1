...
1. **주성분 분석 (PCA)**
    1. 데이터에 있는 **분산이 큰 방향**을 찾는 것 (분산 : 데이터가 퍼져 있는 정도)
        ...
        ![image.png](https://github.com/user-attachments/assets/f95f468e-0f1b-4e80-8062-56145d8b4cdc)
    ...
    2. **주성분 벡터**
        ...
        2. 주성분 벡터의 원소 개수 = 원본 데이터셋의 특성 개수
            ...
            ![2차원 데이터 S(4, 2) → 1차원 데이터 P(4.5)로 투영 (이 데이터가 주성분 방향으로 얼마나 떨어져 있는지 숫자로 표현)](https://github.com/user-attachments/assets/1798d615-3ccf-4e3d-952f-7bd92448f1f5)
